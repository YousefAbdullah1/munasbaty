                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="card daily-sales">
                                        <div class="card-block">
                                            <h6 class="mb-4">Daily Booking</h6>
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="card Monthly-sales">
                                        <div class="card-block">
                                            <h6 class="mb-4">Monthly Booking</h6>
                                            <div class="row d-flex align-items-center">
                                                <div class="col-9">
                                ...
                                <div class="col-md-12 col-xl-4">
                                    <div class="card yearly-sales">
                                        <div class="card-block">
                                            <h6 class="mb-4">Yearly Booking</h6>
                                            <div class="row d-flex align-items-center">
                                                <div class="col-9">
                                                    <h3 class="f-w-300 d-flex align-items-center  m-b-0"><i class="feather icon-arrow-up text-c-green f-30 m-r-10"></i>$
                                                        8.638.32</h3>
                                                ...
                                                <table class="table table-hover">
                                                    <tbody>
                                                        <tr class="unread">
                                                            ...
                                                            <td><a href="../views\auth\login.php" class="label theme-bg2 text-white f-12">Reject</a>
                                                                <a href="../views\auth\login.php" class="label theme-bg text-white f-12">Approve</a>
                                                            </td>
                                                        </tr>
                                                        <tr class="unread">
                                                            <td><img class="rounded-circle" style="width:40px;" src="assets/images/user/avatar-2.jpg" alt="activity-user"></td>
                                                            <td>
                                                                <h6 class="mb-1">Mohammed Alsaeedy</h6>
                                                                <p class="m-0">CEO</p>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td><a href="../views\auth\login.php" class="label theme-bg2 text-white f-12">Reject</a><a href="../views\auth\login.php" class="label theme-bg text-white f-12">Approve</a>
                                                            </td>
                                                        </tr>
                                                        <tr class="unread">
                                                            <td><img class="rounded-circle" style="width:40px;" src="assets/images/user/avatar-3.jpg" alt="activity-user"></td>
                                                            <td>
                                                                <h6 class="mb-1">Bassem adel</h6>
                                                                <p class="m-0">Party</p>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr class="unread">
                                                            <td><img class="rounded-circle" style="width:40px;" src="assets/images/user/avatar-1.jpg" alt="activity-user"></td>
                                                            <td>
                                                                <h6 class="mb-1">Yasser Almalhee</h6>
                                                        ...
                                                        <tr class="unread">
                                                            <td><img class="rounded-circle" style="width:40px;" src="assets/images/user/avatar-2.jpg" alt="activity-user"></td>
                                                            <td>
                                                                <h6 class="mb-1">Ramy Alassely</h6>
                                                                <p class="m-0">Malware Analysis</p>
                                                            </td>
                                                            <td>
                                        ...
                                        <div class="tab-pane fade" id="home" role="tabpanel" aria-labelledby="home-tab">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle m-r-10" style="width:40px;" src="assets/images/user/avatar-1.jpg" alt="activity-user">Bassem Adel</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">Party</h6>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="assets/images/user/avatar-2.jpg" alt="activity-user">Salah Ali</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">Weeding</h6>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="assets/images/user/avatar-3.jpg" alt="activity-user">Mohammed Alsqaf</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">Weeding</h6>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="assets/images/user/avatar-1.jpg" alt="activity-user">Osama Abdullah</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">Party</h6>
                                                        </td>
                                        ...
                                        <div class="tab-pane fade active show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="assets/images/user/avatar-2.jpg" alt="activity-user">Alaa Alkamel</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">Party</h6>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle m-r-10" style="width:40px;" src="assets/images/user/avatar-1.jpg" alt="activity-user">Abdullamged Alsafany</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">graduation party</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">3:28 PM</h6>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="assets/images/user/avatar-1.jpg" alt="activity-user">Mohammed</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">Kac</h6>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="assets/images/user/avatar-3.jpg" alt="activity-user">Salah ali</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">Party</h6>
                                                        </td>
                                        ...
                                        <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="assets/images/user/avatar-3.jpg" alt="activity-user">Sarah</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">Kake</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">10:23 AM</h6>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle m-r-10" style="width:40px;" src="assets/images/user/avatar-1.jpg" alt="activity-user">Aeemen almutareb</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">Booking all the weeding from the website
                                                            </h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">3:28 PM</h6>

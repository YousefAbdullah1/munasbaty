                                                        ...
                                                        <div class="col-md-12">
                                                            <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="food_id" class="form-control" id="exampleFormControlSelect1">
                                                                        <?php
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="artist_id" class="form-control" id="exampleFormControlSelect1">
                                                                        <?php
                                                                ...
                                                                <div class=" form-group">
                                                                    ...
                                                                    <input name="booking_date" type="date" class="form-control" value="<?= $booking_date ?>">
                                                                </div>
                                                                <div class=" form-group">
                                                                    <label>Price</label>
                                                                    <input name="price" type="number" class="form-control" value="<?= $price ?>">
                                                                </div>
                                                                <div class=" form-group">
                                                                    <label>Special Request</label>
                                                                    <textarea name="special_request" class="form-control"><?= $special_request ?></textarea>
                                                                </div>
